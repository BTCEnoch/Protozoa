...
export interface EventEmitter {
  on(type: EventType, listener: EventListener, priority?: EventPriority): EventSubscription;
  once(type: EventType, listener: EventListener, priority?: EventPriority): EventSubscription;

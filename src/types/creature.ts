...
import { Role, AttributeType, Rarity, Tier, RoleToAttributeType } from './core';
import { BlockData } from './bitcoin';
import { Mutation } from './trait';
...
export interface CreatureGroup {
  id: string;
  role: Role;
  subclass: any; // This would be DynamicSubclass | PredefinedSubclass
  particles: number;
